...
const CreateReport = () => {
  const { _id, position, firstName, middleName, lastName ,userAddress } = useUserStore();
  const defaultFormData = {
    ...
    reporterUserAddress: userAddress,
  };
  ...
  return (
    <main className="min-h-screen lg:pt-20 pt-16 pb-4  relative">
      ...
      <Card className="p-10 max-w-xl sm:mx-auto mx-2">
        ...
        Grievance Petition Redressal

        </Typography>
        <Typography color="gray" className="mt-1 font-normal">
          To report, please provide the following
          information&apos;s
        </Typography>
        <hr className="mt-8" />
