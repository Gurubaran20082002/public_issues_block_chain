  ...
  return (
    <form className="my-2 w-auto">
      <section className="mb-1 flex flex-col gap-6">
        ...
        />
        <Typography variant="h6" color="blue-gray" className="-mb-3">
        Have you raised any complaints before?
        </Typography>
        <Textarea
          placeholder="Message"
          className=" !border-t-blue-gray-200 focus:!border-t-gray-900"
        ...
        />
        <Typography variant="h6" color="blue-gray" className="-mb-3">
        If so what is your acknowledgement number?
        </Typography>
        <Textarea
          placeholder="Message"
          className=" !border-t-blue-gray-200 focus:!border-t-gray-900"
        ...
        <Typography variant="h6" color="blue-gray" className="-mb-3">
        What was the result of that submitted complaint?
        </Typography>
        <Textarea
        ...
        <section>
          <Typography variant="h6" color="blue-gray" className="-mb-2">
            {readOnly ? "Attached file(s):" : "Upload proof files here:"}
          </Typography>
